...
(function( $ ){
  ...
  var months = {
    ...
    "long": ["Jänner", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"] },
      todayDate = new Date(),
  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var $fieldset = $("<fieldset class='birthday-picker'></fieldset>"),
          $year = $("<select class='birth-year' name='birth[year]' id='birth[year]'></select>"),
          $month = $("<select class='birth-month' name='birth[month]' id='birth[month]'></select>"),
          $day = $("<select class='birth-day' name='birth[day]' id='birth[day]'></select>");
