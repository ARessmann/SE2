 ...
 * limitations under the License.
 * ========================================================= */
!function(e){"use strict";var t=function(t,n){this.$element=e(t);this.options=e.extend({},e.fn.timepicker.defaults,n,this.$element.data());this.minuteStep=this.options.minuteStep||this.minuteStep;this.secondStep=this.options.secondStep||this.secondStep;this.showMeridian=this.options.showMeridian||this.showMeridian;this.showSeconds=this.options.showSeconds||this.showSeconds;this.showInputs=this.options.showInputs||this.showInputs;this.disableFocus=this.options.disableFocus||this.disableFocus;this.template=this.options.template||this.template;this.modalBackdrop=this.options.modalBackdrop||this.modalBackdrop;this.defaultTime=this.options.defaultTime||this.defaultTime;this.open=false;this.init()};t.prototype={constructor:t,init:function(){if(this.$element.parent().hasClass("input-append")||this.$element.parent().hasClass("input-prepend")){this.$element.parent(".input-append").find(".add-on").on("click",e.proxy(this.showWidget,this));this.$element.parent(".input-prepend").find(".add-on").on("click",e.proxy(this.showWidget,this));this.$element.parent(".input-prepend").find("input").on("click",e.proxy(this.showWidget,this));this.$element.on({keypress:e.proxy(this.elementKeypress,this),blur:e.proxy(this.updateFromElementVal,this)})}else{if(this.template){this.$element.on({focus:e.proxy(this.showWidget,this),click:e.proxy(this.showWidget,this),blur:e.proxy(this.updateFromElementVal,this)})}else{this.$element.on({keypress:e.proxy(this.elementKeypress,this),blur:e.proxy(this.updateFromElementVal,this)})}}this.$widget=e(this.getTemplate()).appendTo("body");this.$widget.on("click",e.proxy(this.widgetClick,this));if(this.showInputs){this.$widget.find("input").on({click:function(){this.select()},keypress:e.proxy(this.widgetKeypress,this),change:e.proxy(this.updateFromWidgetInputs,this)})}this.setDefaultTime(this.defaultTime)},showWidget:function(t){t.stopPropagation();t.preventDefault();if(this.open){return}this.$element.trigger("show");if(this.disableFocus){this.$element.blur()}var n=e.extend({},this.$element.offset(),{height:this.$element[0].offsetHeight});this.updateFromElementVal();e("html").trigger("click.timepicker.data-api").one("click.timepicker.data-api",e.proxy(this.hideWidget,this));if(this.template==="modal"){this.$widget.modal("show").on("hidden",e.proxy(this.hideWidget,this))}else{this.$widget.css({top:n.top+n.height,left:n.left});if(!this.open){this.$widget.addClass("open")}}this.open=true;this.$element.trigger("shown")},hideWidget:function(){this.$element.trigger("hide");if(this.template==="modal"){this.$widget.modal("hide")}else{this.$widget.removeClass("open")}this.open=false;this.$element.trigger("hidden")},widgetClick:function(t){t.stopPropagation();t.preventDefault();var n=e(t.target).closest("a").data("action");if(n){this[n]();this.update()}},widgetKeypress:function(t){var n=e(t.target).closest("input").attr("name");switch(t.keyCode){case 9:if(this.showMeridian){if(n=="meridian"){this.hideWidget()}}else{if(this.showSeconds){if(n=="second"){this.hideWidget()}}else{if(n=="minute"){this.hideWidget()}}}break;case 27:this.hideWidget();break;case 38:switch(n){case"hour":this.incrementHour();break;case"minute":this.incrementMinute();break;case"second":this.incrementSecond();break;case"meridian":this.toggleMeridian();break}this.update();break;case 40:switch(n){case"hour":this.decrementHour();break;case"minute":this.decrementMinute();break;case"second":this.decrementSecond();break;case"meridian":this.toggleMeridian();break}this.update();break}},elementKeypress:function(e){var t=this.$element.get(0);switch(e.keyCode){case 0:break;case 9:this.updateFromElementVal();if(this.showMeridian){if(this.highlightedUnit!="meridian"){e.preventDefault();this.highlightNextUnit()}}else{if(this.showSeconds){if(this.highlightedUnit!="second"){e.preventDefault();this.highlightNextUnit()}}else{if(this.highlightedUnit!="minute"){e.preventDefault();this.highlightNextUnit()}}}break;case 27:this.updateFromElementVal();break;case 37:this.updateFromElementVal();this.highlightPrevUnit();break;case 38:switch(this.highlightedUnit){case"hour":this.incrementHour();break;case"minute":this.incrementMinute();break;case"second":this.incrementSecond();break;case"meridian":this.toggleMeridian();break}this.updateElement();break;case 39:this.updateFromElementVal();this.highlightNextUnit();break;case 40:switch(this.highlightedUnit){case"hour":this.decrementHour();break;case"minute":this.decrementMinute();break;case"second":this.decrementSecond();break;case"meridian":this.toggleMeridian();break}this.updateElement();break}if(e.keyCode!==0&&e.keyCode!==8&&e.keyCode!==9&&e.keyCode!==46){e.preventDefault()}},setValues:function(e){if(this.showMeridian){var t=e.split(" ");var n=t[0].split(":");this.meridian=t[1]}else{var n=e.split(":")}this.hour=parseInt(n[0],10);this.minute=parseInt(n[1],10);this.second=parseInt(n[2],10);if(isNaN(this.hour)){this.hour=1}if(isNaN(this.minute)){this.minute=0}if(this.showMeridian){if(this.hour>12){this.hour=12}else if(this.hour<1){this.hour=1}if(this.meridian=="am"||this.meridian=="a"){this.meridian="AM"}else if(this.meridian=="pm"||this.meridian=="p"){this.meridian="PM"}if(this.meridian!="AM"&&this.meridian!="PM"){this.meridian="AM"}}if(this.minute<0){this.minute=0}else if(this.minute>60){this.minute=60}if(this.showSeconds){if(isNaN(this.second)){this.second=0}else if(this.second<0){this.second=0}else if(this.second>60){this.second=60}}this.updateElement();this.updateWidget()},setMeridian:function(e){if(e=="a"||e=="am"||e=="AM"){this.meridian="AM"}else if(e=="p"||e=="pm"||e=="PM"){this.meridian="PM"}else{this.updateWidget()}this.updateElement()},setDefaultTime:function(e){if(e){if(e==="current"){var t=new Date;var n=t.getHours();var r=Math.floor(t.getMinutes()/this.minuteStep)*this.minuteStep;var i=Math.floor(t.getSeconds()/this.secondStep)*this.secondStep;var s="AM";if(this.showMeridian){if(n===0){n=12}else if(n>=12){if(n>12){n=n-12}s="PM"}else{s="AM"}}this.hour=n;this.minute=r;this.second=i;this.meridian=s}else if(e==="value"){this.setValues(this.$element.val())}else{this.setValues(e)}this.update()}else{this.hour=0;this.minute=0;this.second=0}},formatTime:function(e,t,n,r){e=e<10?"0"+e:e;t=t<10?"0"+t:t;n=n<10?"0"+n:n;return e+":"+t+(this.showSeconds?":"+n:"")+(this.showMeridian?" "+r:"")},getTime:function(){return this.formatTime(this.hour,this.minute,this.second,this.meridian)},setTime:function(e){this.setValues(e);this.update()},update:function(){this.updateElement();this.updateWidget()},updateElement:function(){var e=this.getTime();this.$element.val(e).change();switch(this.highlightedUnit){case"hour":this.highlightHour();break;case"minute":this.highlightMinute();break;case"second":this.highlightSecond();break;case"meridian":this.highlightMeridian();break}},updateWidget:function(){if(this.showInputs){this.$widget.find("input.bootstrap-timepicker-hour").val(this.hour<10?"0"+this.hour:this.hour);this.$widget.find("input.bootstrap-timepicker-minute").val(this.minute<10?"0"+this.minute:this.minute);if(this.showSeconds){this.$widget.find("input.bootstrap-timepicker-second").val(this.second<10?"0"+this.second:this.second)}if(this.showMeridian){this.$widget.find("input.bootstrap-timepicker-meridian").val(this.meridian)}}else{this.$widget.find("span.bootstrap-timepicker-hour").text(this.hour);this.$widget.find("span.bootstrap-timepicker-minute").text(this.minute<10?"0"+this.minute:this.minute);if(this.showSeconds){this.$widget.find("span.bootstrap-timepicker-second").text(this.second<10?"0"+this.second:this.second)}if(this.showMeridian){this.$widget.find("span.bootstrap-timepicker-meridian").text(this.meridian)}}},updateFromElementVal:function(e){var t=this.$element.val();if(t){this.setValues(t);this.updateWidget()}},updateFromWidgetInputs:function(){var e=this.$widget.find("input.bootstrap-timepicker-hour").val()+":"+this.$widget.find("input.bootstrap-timepicker-minute").val()+(this.showSeconds?":"+this.$widget.find("input.bootstrap-timepicker-second").val():"")+(this.showMeridian?" "+this.$widget.find("input.bootstrap-timepicker-meridian").val():"");this.setValues(e)},getCursorPosition:function(){var e=this.$element.get(0);if("selectionStart"in e){return e.selectionStart}else if(document.selection){e.focus();var t=document.selection.createRange();var n=document.selection.createRange().text.length;t.moveStart("character",-e.value.length);return t.text.length-n}},highlightUnit:function(){var e=this.$element.get(0);this.position=this.getCursorPosition();if(this.position>=0&&this.position<=2){this.highlightHour()}else if(this.position>=3&&this.position<=5){this.highlightMinute()}else if(this.position>=6&&this.position<=8){if(this.showSeconds){this.highlightSecond()}else{this.highlightMeridian()}}else if(this.position>=9&&this.position<=11){this.highlightMeridian()}},highlightNextUnit:function(){switch(this.highlightedUnit){case"hour":this.highlightMinute();break;case"minute":if(this.showSeconds){this.highlightSecond()}else{this.highlightMeridian()}break;case"second":this.highlightMeridian();break;case"meridian":this.highlightHour();break}},highlightPrevUnit:function(){switch(this.highlightedUnit){case"hour":this.highlightMeridian();break;case"minute":this.highlightHour();break;case"second":this.highlightMinute();break;case"meridian":if(this.showSeconds){this.highlightSecond()}else{this.highlightMinute()}break}},highlightHour:function(){this.highlightedUnit="hour";this.$element.get(0).setSelectionRange(0,2)},highlightMinute:function(){this.highlightedUnit="minute";this.$element.get(0).setSelectionRange(3,5)},highlightSecond:function(){this.highlightedUnit="second";this.$element.get(0).setSelectionRange(6,8)},highlightMeridian:function(){this.highlightedUnit="meridian";if(this.showSeconds){this.$element.get(0).setSelectionRange(9,11)}else{this.$element.get(0).setSelectionRange(6,8)}},incrementHour:function(){if(this.showMeridian){if(this.hour===11){this.toggleMeridian()}else if(this.hour===12){return this.hour=1}}if(this.hour===23){return this.hour=0}this.hour=this.hour+1},decrementHour:function(){if(this.showMeridian){if(this.hour===1){return this.hour=12}else if(this.hour===12){this.toggleMeridian()}}if(this.hour===0){return this.hour=23}this.hour=this.hour-1},incrementMinute:function(){var e=this.minute+this.minuteStep-this.minute%this.minuteStep;if(e>59){this.incrementHour();this.minute=e-60}else{this.minute=e}},decrementMinute:function(){var e=this.minute-this.minuteStep;if(e<0){this.decrementHour();this.minute=e+60}else{this.minute=e}},incrementSecond:function(){var e=this.second+this.secondStep-this.second%this.secondStep;if(e>59){this.incrementMinute();this.second=e-60}else{this.second=e}},decrementSecond:function(){var e=this.second-this.secondStep;if(e<0){this.decrementMinute();this.second=e+60}else{this.second=e}},toggleMeridian:function(){this.meridian=this.meridian==="AM"?"PM":"AM";this.update()},getTemplate:function(){if(this.options.templates[this.options.template]){return this.options.templates[this.options.template]}if(this.showInputs){var e='<input type="text" name="hour" class="bootstrap-timepicker-hour" maxlength="2"/>';var t='<input type="text" name="minute" class="bootstrap-timepicker-minute" maxlength="2"/>';var n='<input type="text" name="second" class="bootstrap-timepicker-second" maxlength="2"/>';var r='<input type="text" name="meridian" class="bootstrap-timepicker-meridian" maxlength="2"/>'}else{var e='<span class="bootstrap-timepicker-hour"></span>';var t='<span class="bootstrap-timepicker-minute"></span>';var n='<span class="bootstrap-timepicker-second"></span>';var r='<span class="bootstrap-timepicker-meridian"></span>'}var i='<table class="'+(this.showSeconds?"show-seconds":"")+" "+(this.showMeridian?"show-meridian":"")+'">'+"<tr>"+'<td><a href="#" data-action="incrementHour"><i class="icon-chevron-up"></i></a></td>'+'<td class="separator">&nbsp;</td>'+'<td><a href="#" data-action="incrementMinute"><i class="icon-chevron-up"></i></a></td>'+(this.showSeconds?'<td class="separator">&nbsp;</td>'+'<td><a href="#" data-action="incrementSecond"><i class="icon-chevron-up"></i></a></td>':"")+(this.showMeridian?'<td class="separator">&nbsp;</td>'+'<td class="meridian-column"><a href="#" data-action="toggleMeridian"><i class="icon-chevron-up"></i></a></td>':"")+"</tr>"+"<tr>"+"<td>"+e+"</td> "+'<td class="separator">:</td>'+"<td>"+t+"</td> "+(this.showSeconds?'<td class="separator">:</td>'+"<td>"+n+"</td>":"")+(this.showMeridian?'<td class="separator">&nbsp;</td>'+"<td>"+r+"</td>":"")+"</tr>"+"<tr>"+'<td><a href="#" data-action="decrementHour"><i class="icon-chevron-down"></i></a></td>'+'<td class="separator"></td>'+'<td><a href="#" data-action="decrementMinute"><i class="icon-chevron-down"></i></a></td>'+(this.showSeconds?'<td class="separator">&nbsp;</td>'+'<td><a href="#" data-action="decrementSecond"><i class="icon-chevron-down"></i></a></td>':"")+(this.showMeridian?'<td class="separator">&nbsp;</td>'+'<td><a href="#" data-action="toggleMeridian"><i class="icon-chevron-down"></i></a></td>':"")+"</tr>"+"</table>";var s;switch(this.options.template){case"modal":s='<div class="bootstrap-timepicker modal hide fade in" style="top: 30%; margin-top: 0; width: 200px; margin-left: -100px;" data-backdrop="'+(this.modalBackdrop?"true":"false")+'">'+'<div class="modal-header">'+'<a href="#" class="close" data-dismiss="modal">×</a>'+"<h3>Pick a Time</h3>"+"</div>"+'<div class="modal-content">'+i+"</div>"+'<div class="modal-footer">'+'<a href="#" class="btn btn-primary" data-dismiss="modal">Ok</a>'+"</div>"+"</div>";break;case"dropdown":s='<div class="bootstrap-timepicker dropdown-menu">'+i+"</div>";break}return s}};e.fn.timepicker=function(n){return this.each(function(){var r=e(this),i=r.data("timepicker"),s=typeof n=="object"&&n;if(!i){r.data("timepicker",i=new t(this,s))}if(typeof n=="string"){i[n]()}})};e.fn.timepicker.defaults={minuteStep:15,secondStep:15,disableFocus:false,defaultTime:"current",showSeconds:false,showInputs:true,showMeridian:true,template:"dropdown",modalBackdrop:false,templates:{}};e.fn.timepicker.Constructor=t}(window.jQuery);

/* Embeded JavaScript */
(function(){var rsplit=function(e,t){var n=t.exec(e),r=new Array,i,s,o;while(n!=null){i=n.index;s=t.lastIndex;if(i!=0){o=e.substring(0,i);r.push(e.substring(0,i));e=e.slice(i)}r.push(n[0]);e=e.slice(n[0].length);n=t.exec(e)}if(!e==""){r.push(e)}return r},chop=function(e){return e.substr(0,e.length-1)},extend=function(e,t){for(var n in t){if(t.hasOwnProperty(n))e[n]=t[n]}};EJS=function(e){e=typeof e=="string"?{view:e}:e;this.set_options(e);if(e.precompiled){this.template={};this.template.process=e.precompiled;EJS.update(this.name,this);return}if(e.element){if(typeof e.element=="string"){var t=e.element;e.element=document.getElementById(e.element);if(e.element==null)throw t+"does not exist!"}if(e.element.value){this.text=e.element.value}else{this.text=e.element.innerHTML}this.name=e.element.id;this.type="["}else if(e.url){e.url=EJS.endExt(e.url,this.extMatch);this.name=this.name?this.name:e.url;var n=e.url;var r=EJS.get(this.name,this.cache);if(r)return r;if(r==EJS.INVALID_PATH)return null;try{this.text=EJS.request(n+(this.cache?"":"?"+Math.random()))}catch(i){}if(this.text==null){throw{type:"EJS",message:"There is no template at "+n}}}var r=new EJS.Compiler(this.text,this.type);r.compile(e,this.name);EJS.update(this.name,this);this.template=r};EJS.prototype={render:function(e,t){e=e||{};this._extra_helpers=t;var n=new EJS.Helpers(e,t||{});return this.template.process.call(e,e,n)},update:function(element,options){if(typeof element=="string"){element=document.getElementById(element)}if(options==null){_template=this;return function(e){EJS.prototype.update.call(_template,element,e)}}if(typeof options=="string"){params={};params.url=options;_template=this;params.onComplete=function(request){var object=eval(request.responseText);EJS.prototype.update.call(_template,element,object)};EJS.ajax_request(params)}else{element.innerHTML=this.render(options)}},out:function(){return this.template.out},set_options:function(e){this.type=e.type||EJS.type;this.cache=e.cache!=null?e.cache:EJS.cache;this.text=e.text||null;this.name=e.name||null;this.ext=e.ext||EJS.ext;this.extMatch=new RegExp(this.ext.replace(/\./,"."))}};EJS.endExt=function(e,t){if(!e)return null;t.lastIndex=0;return e+(t.test(e)?"":this.ext)};EJS.Scanner=function(e,t,n){extend(this,{left_delimiter:t+"%",right_delimiter:"%"+n,double_left:t+"%%",double_right:"%%"+n,left_equal:t+"%=",left_comment:t+"%#"});this.SplitRegexp=t=="["?/(\[%%)|(%%\])|(\[%=)|(\[%#)|(\[%)|(%\]\n)|(%\])|(\n)/:new RegExp("("+this.double_left+")|(%%"+this.double_right+")|("+this.left_equal+")|("+this.left_comment+")|("+this.left_delimiter+")|("+this.right_delimiter+"\n)|("+this.right_delimiter+")|(\n)");this.source=e;this.stag=null;this.lines=0};EJS.Scanner.to_text=function(e){if(e==null||e===undefined)return"";if(e instanceof Date)return e.toDateString();if(e.toString)return e.toString();return""};EJS.Scanner.prototype={scan:function(e){scanline=this.scanline;regex=this.SplitRegexp;if(!this.source==""){var t=rsplit(this.source,/\n/);for(var n=0;n<t.length;n++){var r=t[n];this.scanline(r,regex,e)}}},scanline:function(e,t,n){this.lines++;var r=rsplit(e,t);for(var i=0;i<r.length;i++){var s=r[i];if(s!=null){try{n(s,this)}catch(o){throw{type:"EJS.Scanner",line:this.lines}}}}}};EJS.Buffer=function(e,t){this.line=new Array;this.script="";this.pre_cmd=e;this.post_cmd=t;for(var n=0;n<this.pre_cmd.length;n++){this.push(e[n])}};EJS.Buffer.prototype={push:function(e){this.line.push(e)},cr:function(){this.script=this.script+this.line.join("; ");this.line=new Array;this.script=this.script+"\n"},close:function(){if(this.line.length>0){for(var e=0;e<this.post_cmd.length;e++){this.push(pre_cmd[e])}this.script=this.script+this.line.join("; ");line=null}}};EJS.Compiler=function(e,t){this.pre_cmd=["var ___ViewO = [];"];this.post_cmd=new Array;this.source=" ";if(e!=null){if(typeof e=="string"){e=e.replace(/\r\n/g,"\n");e=e.replace(/\r/g,"\n");this.source=e}else if(e.innerHTML){this.source=e.innerHTML}if(typeof this.source!="string"){this.source=""}}t=t||"<";var n=">";switch(t){case"[":n="]";break;case"<":break;default:throw t+" is not a supported deliminator";break}this.scanner=new EJS.Scanner(this.source,t,n);this.out=""};EJS.Compiler.prototype={compile:function(options,name){options=options||{};this.out="";var put_cmd="___ViewO.push(";var insert_cmd=put_cmd;var buff=new EJS.Buffer(this.pre_cmd,this.post_cmd);var content="";var clean=function(e){e=e.replace(/\\/g,"\\\\");e=e.replace(/\n/g,"\\n");e=e.replace(/"/g,'\\"');return e};this.scanner.scan(function(e,t){if(t.stag==null){switch(e){case"\n":content=content+"\n";buff.push(put_cmd+'"'+clean(content)+'");');buff.cr();content="";break;case t.left_delimiter:case t.left_equal:case t.left_comment:t.stag=e;if(content.length>0){buff.push(put_cmd+'"'+clean(content)+'")')}content="";break;case t.double_left:content=content+t.left_delimiter;break;default:content=content+e;break}}else{switch(e){case t.right_delimiter:switch(t.stag){case t.left_delimiter:if(content[content.length-1]=="\n"){content=chop(content);buff.push(content);buff.cr()}else{buff.push(content)}break;case t.left_equal:buff.push(insert_cmd+"(EJS.Scanner.to_text("+content+")))");break}t.stag=null;content="";break;case t.double_right:content=content+t.right_delimiter;break;default:content=content+e;break}}});if(content.length>0){buff.push(put_cmd+'"'+clean(content)+'")')}buff.close();this.out=buff.script+";";var to_be_evaled="/*"+name+"*/this.process = function(_CONTEXT,_VIEW) { try { with(_VIEW) { with (_CONTEXT) {"+this.out+" return ___ViewO.join('');}}}catch(e){e.lineNumber=null;throw e;}};";try{eval(to_be_evaled)}catch(e){if(typeof JSLINT!="undefined"){JSLINT(this.out);for(var i=0;i<JSLINT.errors.length;i++){var error=JSLINT.errors[i];if(error.reason!="Unnecessary semicolon."){error.line++;var e=new Error;e.lineNumber=error.line;e.message=error.reason;if(options.view)e.fileName=options.view;throw e}}}else{throw e}}}};EJS.config=function(e){EJS.cache=e.cache!=null?e.cache:EJS.cache;EJS.type=e.type!=null?e.type:EJS.type;EJS.ext=e.ext!=null?e.ext:EJS.ext;var t=EJS.templates_directory||{};EJS.templates_directory=t;EJS.get=function(e,n){if(n==false)return null;if(t[e])return t[e];return null};EJS.update=function(e,n){if(e==null)return;t[e]=n};EJS.INVALID_PATH=-1};EJS.config({cache:true,type:"<",ext:".ejs"});EJS.Helpers=function(e,t){this._data=e;this._extras=t;extend(this,t)};EJS.Helpers.prototype={view:function(e,t,n){if(!n)n=this._extras;if(!t)t=this._data;return(new EJS(e)).render(t,n)},to_text:function(e,t){if(e==null||e===undefined)return t||"";if(e instanceof Date)return e.toDateString();if(e.toString)return e.toString().replace(/\n/g,"<br />").replace(/''/g,"'");return""}};EJS.newRequest=function(){var e=[function(){return new ActiveXObject("Msxml2.XMLHTTP")},function(){return new XMLHttpRequest},function(){return new ActiveXObject("Microsoft.XMLHTTP")}];for(var t=0;t<e.length;t++){try{var n=e[t]();if(n!=null)return n}catch(r){continue}}};EJS.request=function(e){var t=new EJS.newRequest;t.open("GET",e,false);try{t.send(null)}catch(n){return null}if(t.status==404||t.status==2||t.status==0&&t.responseText=="")return null;return t.responseText};EJS.ajax_request=function(e){e.method=e.method?e.method:"GET";var t=new EJS.newRequest;t.onreadystatechange=function(){if(t.readyState==4){if(t.status==200){e.onComplete(t)}else{e.onComplete(t)}}};t.open(e.method,e.url);t.send(null)}})();

/* View.js */
EJS.Helpers.prototype.date_tag=function(e,t,n){if(!(t instanceof Date))t=new Date;var r=["January","February","March","April","May","June","July","August","September","October","November","December"];var i=[],s=[],o=[];var u=t.getFullYear();var a=t.getMonth();var f=t.getDate();for(var l=u-15;l<u+15;l++){i.push({value:l,text:l})}for(var c=0;c<12;c++){s.push({value:c,text:r[c]})}for(var h=0;h<31;h++){o.push({value:h+1,text:h+1})}var p=this.select_tag(e+"[year]",u,i,{id:e+"[year]"});var d=this.select_tag(e+"[month]",a,s,{id:e+"[month]"});var v=this.select_tag(e+"[day]",f,o,{id:e+"[day]"});return p+d+v};EJS.Helpers.prototype.form_tag=function(e,t){t=t||{};t.action=e;if(t.multipart==true){t.method="post";t.enctype="multipart/form-data"}return this.start_tag_for("form",t)};EJS.Helpers.prototype.form_tag_end=function(){return this.tag_end("form")};EJS.Helpers.prototype.hidden_field_tag=function(e,t,n){return this.input_field_tag(e,t,"hidden",n)};EJS.Helpers.prototype.input_field_tag=function(e,t,n,r){r=r||{};r.id=r.id||e;r.value=t||"";r.type=n||"text";r.name=e;return this.single_tag_for("input",r)};EJS.Helpers.prototype.is_current_page=function(e){return window.location.href==e||window.location.pathname==e?true:false};EJS.Helpers.prototype.link_to=function(e,t,n){if(!e)var e="null";if(!n)var n={};if(n.confirm){n.onclick=' var ret_confirm = confirm("'+n.confirm+'"); if(!ret_confirm){ return false;} ';n.confirm=null}n.href=t;return this.start_tag_for("a",n)+e+this.tag_end("a")};EJS.Helpers.prototype.submit_link_to=function(e,t,n){if(!e)var e="null";if(!n)var n={};n.onclick=n.onclick||"";if(n.confirm){n.onclick=' var ret_confirm = confirm("'+n.confirm+'"); if(!ret_confirm){ return false;} ';n.confirm=null}n.value=e;n.type="submit";n.onclick=n.onclick+(t?this.url_for(t):"")+"return false;";return this.start_tag_for("input",n)};EJS.Helpers.prototype.link_to_if=function(e,t,n,r,i,s){return this.link_to_unless(e==false,t,n,r,i,s)};EJS.Helpers.prototype.link_to_unless=function(e,t,n,r,i){r=r||{};if(e){if(i&&typeof i=="function"){return i(t,n,r,i)}else{return t}}else return this.link_to(t,n,r)};EJS.Helpers.prototype.link_to_unless_current=function(e,t,n,r){n=n||{};return this.link_to_unless(this.is_current_page(t),e,t,n,r)};EJS.Helpers.prototype.password_field_tag=function(e,t,n){return this.input_field_tag(e,t,"password",n)};EJS.Helpers.prototype.select_tag=function(e,t,n,r){r=r||{};r.id=r.id||e;r.value=t;r.name=e;var i="";i+=this.start_tag_for("select",r);for(var s=0;s<n.length;s++){var o=n[s];var u={value:o.value};if(o.value==t)u.selected="selected";i+=this.start_tag_for("option",u)+o.text+this.tag_end("option")}i+=this.tag_end("select");return i};EJS.Helpers.prototype.single_tag_for=function(e,t){return this.tag(e,t,"/>")};EJS.Helpers.prototype.start_tag_for=function(e,t){return this.tag(e,t)};EJS.Helpers.prototype.submit_tag=function(e,t){t=t||{};t.type=t.type||"submit";t.value=e||"Submit";return this.single_tag_for("input",t)};EJS.Helpers.prototype.tag=function(e,t,n){if(!n)var n=">";var r=" ";for(var i in t){if(t[i]!=null)var s=t[i].toString();else var s="";if(i=="Class")i="class";if(s.indexOf("'")!=-1)r+=i+'="'+s+'" ';else r+=i+"='"+s+"' "}return"<"+e+r+n};EJS.Helpers.prototype.tag_end=function(e){return"</"+e+">"};EJS.Helpers.prototype.text_area_tag=function(e,t,n){n=n||{};n.id=n.id||e;n.name=n.name||e;t=t||"";if(n.size){n.cols=n.size.split("x")[0];n.rows=n.size.split("x")[1];delete n.size}n.cols=n.cols||50;n.rows=n.rows||4;return this.start_tag_for("textarea",n)+t+this.tag_end("textarea")};EJS.Helpers.prototype.text_tag=EJS.Helpers.prototype.text_area_tag;EJS.Helpers.prototype.text_field_tag=function(e,t,n){return this.input_field_tag(e,t,"text",n)};EJS.Helpers.prototype.url_for=function(e){return'window.location="'+e+'";'};EJS.Helpers.prototype.img_tag=function(e,t,n){n=n||{};n.src=e;n.alt=t;return this.single_tag_for("img",n)}
...
/* application.js */
function addPresenceInfo(){ANX.debug("addPresenceInfo()");var e={user_id:time_user_selected,username:time_user_selected_username};modal=(new EJS({url:"/assets/tpl/modal_time_add.ejs?v="+version_app})).render(e);$.getJSON("/api/presence-states/",function(e){ANX.debug("GET /api/presence-states/ "+ANX.toJSON(e));var t=$('<select name="modal-add-presence-info-status-select" id="modal-add-presence-info-status-select" class="input">');$(e).each(function(){var e=$("<option>").attr("value",this.id).text(this.name);t.append(e)});$("#modal-add-presence-info-status").html(t);$("#modal-add-presence-info-status").prepend('<span class="add-on"><i class="icon-list"></i></span>')});$.getJSON("/api/locations/",function(e){ANX.debug("GET /api/location/ "+ANX.toJSON(e));var t=$('<select name="modal-add-presence-info-location-select" id="modal-add-presence-info-location-select" class="input">');$(e).each(function(){var e=$("<option>").attr("value",this.id).text(this.name);t.append(e)});$("#modal-add-presence-info-location").html(t);$("#modal-add-presence-info-location").prepend('<span class="add-on"><i class="icon-home"></i></span>')});$("#modal").html(modal);$("#modal-add-presence-info").modal();ANX.invokeDateTimePicker();$("#modal-add-presence-info-submit").on("click",function(){addPresenceInfoSubmit()})}function addPresenceInfoSubmit(){ANX.debug("addPresenceInfoSubmit()");day_data_last=$("#modal-add-presence-info-end-date").val();var e={user_id:$("#modal-add-presence-info-user").attr("data-id"),start_date:$("#modal-add-presence-info-start-date").val(),start_time:$("#modal-add-presence-info-start-time").val(),end_date:$("#modal-add-presence-info-end-date").val(),end_time:$("#modal-add-presence-info-end-time").val(),state_id:$("#modal-add-presence-info-status-select").val(),location_id:$("#modal-add-presence-info-location-select").val(),comment:$("#modal-add-presence-info-comment").val()};e=ANX.toJSON(e);ANX.debug("POST: "+e);$.ajax({data:{data:e},dataType:"json",error:function(){ANX.notify("Unbekannter Fehler","Beim übertragen der Daten ist es zu einem Fehler gekommen","error")},success:function(e){if(e.error==true){ANX.notify("Fehler: "+e["error_title"],e["error_description"],"error")}else{$("#modal-add-presence-info").modal("hide");ANX.notify("Nachtrag gespeichert","Der Zeiteintrag wurde erfolgreich gespeichert","success")}myPresenceInfo(period_last);myPresenceStatusChart(period_last)},type:"POST",url:"/api/presence-info-edit/"})}var version_app="2.0.3";var debug_page=false;var debug_console=false;var debug_full_information=false;var timepickr_last=0;EJS.config({cache:true});$.pnotify.defaults.history=false;$(document).ready(function(){$("#mainmenu a").on("click",function(){$("#mainmenu a").addClass("btn-inverse");$(this).removeClass("btn-inverse")});$("#notifications1").popover({animation:true,title:"Töst Töst",content:"Popover ContentPopover ContentPopover ContentPopover ContentPopover Content",placement:"bottom",trigger:"hover"})});var Interface={lock:function(){ANX.debug("INTERFACE LOCKED");$("#interface-lock").addClass("locked");$("#interface-lock").html("");$("#interface-lock-status").show()},unlock:function(){ANX.debug("INTERFACE UNLOCKED");$("#interface-lock").removeClass("locked");$("#interface-lock").html("");$("#interface-lock-status").hide()}};var ANX={debug:function(e){if(typeof e==="object"){e=JSON.stringify(e,null,"	")}ANX.debugPrint(e)},debugPrint:function(e){var t=new Date;var n=t.getHours()<9?"0"+t.getHours():t.getHours();var r=t.getMinutes()<9?"0"+t.getMinutes():t.getMinutes();var i=t.getSeconds()<9?"0"+t.getSeconds():t.getSeconds();var s=t.getMilliseconds();if(t.getMilliseconds()<9){s="00"+t.getMilliseconds()}else if(t.getMilliseconds()<99){s="0"+t.getMilliseconds()}var o=+n+":"+r+":"+i+":"+s;if(!debug_full_information){var u=e.length>120?"...":"";e=e.substring(0,120)+u}if(debug_page)$("#debug").prepend('<pre id="debug">'+o+"<br/>"+e+"</pre>");if(debug_console)console.log(o+": "+e)},escapeHtml:function(e){return e.replace(/&/g,"&").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")},dateCurrent:function(){var e=new Date;var t=e.getDate();var n=e.getMonth()+1;var r=e.getFullYear();if(t<10){t="0"+t}if(n<10){n="0"+n}return r+"-"+n+"-"+t},dateYesterday:function(){var e=new Date;e.setDate(e.getDate()-1);var t=e.getDate();var n=e.getMonth()+1;var r=e.getFullYear();if(t<10){t="0"+t}if(n<10){n="0"+n}return r+"-"+n+"-"+t},dateYear:function(){var e=new Date;return e.getFullYear()},dateMonth:function(){var e=new Date;var t=e.getMonth()+1;if(t<10){t="0"+t}return t},dateDay:function(){var e=new Date;var t=e.getDate();if(t<10){t="0"+t}return t},dateHour:function(){var e=new Date;var t=e.getHours();if(t<10){t="0"+t}return t},dateMinute:function(){var e=new Date;var t=e.getMinutes();if(t<10){t="0"+t}return t},dateSecond:function(){var e=new Date;var t=e.getSeconds();if(t<10){t="0"+t}return t},notify:function(e,t,n){$.pnotify({title:e,text:t,type:n,animation:"show"})},toJSON:function(e){return JSON.stringify(e)},fromJSON:function(e){return JSON.parse(e)},validateDate:function(e){var t=e.split(".");var n=parseInt(t[0],10);var r=parseInt(t[1],10);var i=parseInt(t[2],10);var e=new Date(i,r-1,n);if(e.getFullYear()==i&&e.getMonth()+1==r&&e.getDate()==n){alert("Valid date")}else{alert("Invalid date")}},invokeDateTimePicker:function(){$(".bt-datepicker").datepicker({weekStart:1,format:"dd.mm.yyyy",changeDate:$(this).change()}).on("changeDate",function(){$(this).change()});$(".bt-timepicker").timepicker({showMeridian:false,minuteStep:1,showWidget:true,defaultTime:false});$(".bt-datepicker").attr("readonly","readonly");$(".bt-timepicker").attr("readonly","readonly");$(".bt-datepicker").attr("data-date-format","dd.mm.yyyy")}};var User={isAdmin:function(e){if(User.isAdminVal==null){var e=typeof e=="undefined"?null:e;var t="/api/user-is-admin";if(e!=null)t+="/id/"+e;var n=false;$.ajax({async:false,dataType:"json",error:function(){ANX.notify("Unbekannter Fehler","Beim übertragen der Daten ist es zu einem Fehler gekommen","error")},success:function(e){User.isAdminVal=e.admin},type:"GET",url:t})}return User.isAdminVal},isAdminVal:null};var Timepickr={increase:function(e,t){var n=parseInt($("#"+e).val());if(n++<t)$("#"+e).val(n++);$("#"+e).focus();Timepickr.format(e)},decrease:function(e,t){var n=parseInt($("#"+e).val());if(n-->t)$("#"+e).val(n--);$("#"+e).focus();Timepickr.format(e)},keyEvent:function(e,t,n,r){var i=$("#"+t).val()==""?"":parseInt($("#"+t).val());var s=e.keyCode;var o=false;if(parseInt(i)||i==""){timepickr_last=i}if(s==38||s==107||s==187){Timepickr.increase(t,r);o=true}if(s==40||s==109||s==189){Timepickr.decrease(t,n);o=true}if(s==33){for(var u=0;u<10;u++)Timepickr.increase(t,r);o=true}if(s==34){for(var u=0;u<10;u++)Timepickr.decrease(t,n);o=true}if(s>=48&&s<=57||s>=96&&s<=105||o||s==37||s==39){if(i>r)$("#"+t).val(r);if(i<n)$("#"+t).val(n)}else{ANX.debug("key NOT allowed");$("#"+t).val(timepickr_last)}},blur:function(e){if($("#"+e).val()=="")$("#"+e).val("00")},format:function(e){if($("#"+e).val()<10&&$("#"+e).val()!="00")$("#"+e).val("0"+$("#"+e).val())}};jQuery.fn.highlight=function(){$(this).each(function(){var e=$(this);$("<div/>").width(e.outerWidth()).height(e.outerHeight()).css({position:"absolute",left:e.offset().left,top:e.offset().top,"background-color":"#ffff99",opacity:".7","z-index":"9999999"}).appendTo("body").fadeOut(1e3).queue(function(){$(this).remove()})})}
